...
public class BinaryTree {
    ...
    public boolean contains(String d) {
        //if the current node data isn't null, and whose data or children data is d, return true
        if (data != null && (data.equals(d) || leftChild.contains(d) || rightChild.contains(d))) {
            return true;
        }
        return false;
    }
