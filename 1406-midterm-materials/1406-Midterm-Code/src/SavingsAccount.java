public class SavingsAccount extends BankAccount {
    private static final double INTEREST_RATE = 0.01; //The interest rate that should be added to the account each month
    private static final double WITHDRAW_FEE = 1.0; //The fee to charge for each withdraw
